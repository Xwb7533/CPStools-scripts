...
class CustomHelpFormatter(argparse.HelpFormatter):
    def format_help(self):
        ...
        description = """
        Extract and sort common protein for phylogenetic analysis.
        Author: Xu wenbo
...
def pro_for_phy(ref_file, output_dir):
    ...
    print(f"Total {len(a)} common protein genes, which have been salved in: \n\t\t{os.path.abspath(saved_gene)}\n"
        f"{'-'*80}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output_dir", help="output directory of protein fasta files")
